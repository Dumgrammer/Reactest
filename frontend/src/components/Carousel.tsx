...
export default function Carousel() {
    ...
    return (
        <>
            <form onSubmit={handleSearchSubmit} className="max-w-xl mb-4 mx-auto">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        required
                    />
                    <button type="submit" className="absolute end-2.5 bottom-2.5 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-white md:hidden">Search</button>
                </div>
            </form>
                ...
                <div className="max-w-1/3 mx-auto">
                    ...
                    <div className="list">
                        {categories.map((category, index) => (
                            <div 
                                key={index} 
                                className="flex flex-col items-center p-6 cursor-pointer hover:opacity-80 transition-opacity"
                                onClick={() => handleCategoryClick(category.name)}
                            >
                                <div className="bg-[#ebebeb] rounded-lg p-7 flex items-center justify-center w-10 h-10 hover:bg-gray-200 transition-colors">
