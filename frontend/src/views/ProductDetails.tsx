                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => prod && addToCart({ _id: prod._id, name: prod.name, image: prod.image, price: prod.price })}  className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
