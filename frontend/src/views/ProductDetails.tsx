...
export default function ProductDetail() {
    ...
    const productDetailReducer = useSelector((state: any) => state.productDetailReducer);
                            ...
                            <div className="container px-5 py-24 mx-auto">
                                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                    <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                                        <h2 className="text-sm title-font text-gray-500 tracking-widest">Review Count: { prod.numReview }</h2>
                                    ...
                                    <img alt={product.name} className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={prod.image} />
                                </div>
                            </div>
                        </section>
                    </>
