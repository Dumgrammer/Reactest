                            ...
                            <div className="container px-5 py-24 mx-auto">
                                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                    ...
                                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        <h2 className="text-sm title-font text-gray-500 tracking-widest">Stocks: {prod.countInStock}</h2>
                                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{prod.name}</h1>
